                    ...
                    <div className="repo_wrapper">
                        <div className="card-details">
                            {/* <div> */}
                                ...
                                <p  className="repo_detail_card_title"><b>Id:</b> <span>{repo.id}</span></p> 
                                <p className="desc-title"><b>Description:</b> <span>{repo.description}</span></p>
                                <p className="desc-title"><b>Language:</b> <span>{repo.language}</span></p>
                                <p className="desc-title"><b>Visibility:</b> <span>{repo.visibility}</span></p>
                                <p className="desc-title"><b>Stargazers:</b> <span>{repo.stargazers_count}</span></p>
                                <p className="desc-title"><b>Created At:</b>  <span>{repo.created_at}</span></p>
                                <p className="desc-title"><b>Updated At:</b> <span>{repo.updated_at}</span></p>
